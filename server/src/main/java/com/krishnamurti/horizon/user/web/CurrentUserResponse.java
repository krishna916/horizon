 ...
 * <ul>
 *   <li>{@code POST /api/v1/register} (201 Created)</li>
 *   <li>{@code POST /api/v1/login} (200 OK)</li>
 *   <li>{@code GET /api/v1/me} (200 OK)</li>
 * </ul>
 * Per M0-000, passwords are never included in API responses.</p>
 */
